        ...
        {type !== "list" &&
          <>
            ...
            <p className="headerDesc">
              Get rewarded for your travels - unlock savings of 10% or more with a free WestBooking account
            </p>
                ...
                {openOptions && 
                  <div className="options">
                    ...
                    <div className="optionItem">
                      ...
                      <div className="optionCounter">
                        <button onClick={() => handleOption("children", "d")} disabled={options.children < 1} className="optionCounterButton">-</button>
